...
public class AddShiftFragment extends AppCompatDialogFragment
{
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState)
    {
        ...
        builder.setView(mFragmentView).setTitle(Html.fromHtml("<font color='#480F7D'>Create a Shift</font>")).setPositiveButton("Accept", (dialog, which) ->
        {
            ...
            mCallingActivity.appendNewShiftToLists(newShift);
        }
    ...
    private void openCalendarFragment(String desiredQuery)
    {
        ...
        calendarWidget.setCallingFragment(this);
